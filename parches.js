...
/* ═══════════════════════════════════════════════════════════════════════
   NEXUS PRO - SELECTOR 3D CON TIPOGRAFÍA CORREGIDA
   ═══════════════════════════════════════════════════════════════════════ */
...
(function() {
    ...
    const injectPremiumCSS = () => {
        ...
        style.innerHTML = `
            ...
            .nx-3d-select { 
                min-width: 320px; padding: 12px 15px; border: none; border-radius: 12px; 
                font-weight: 800; font-size: 20px; color: #1e293b; text-align: center;
                background: #f0f4f8;
                box-shadow: inset 4px 4px 8px #d1d9e6, inset -4px -4px 8px #ffffff;
                appearance: none; -webkit-appearance: none; cursor: pointer;
                transition: all 0.3s ease; font-family: sans-serif;
...
(function() {
    ...
    const injectPremiumCSS = () => {
        ...
        style.innerHTML = `
            ...
            .nx-3d-select { 
                /* CORRECCIÓN DE TAMAÑO: EQUILIBRADO */
                min-width: 280px; padding: 10px; border: none; border-radius: 10px; 
                font-weight: 700; font-size: 18px; color: #334155; text-align: center;
                background: #f1f5f9;
            ...
            .nx-3d-btn:hover:not(:disabled) { transform: scale(1.05); color: #1d4ed8; background: #fff; }
            .nx-3d-btn:active { box-shadow: inset 2px 2px 4px #cbd5e1, inset -2px -2px 4px #ffffff; }
            .nx-3d-btn:disabled { opacity: 0.3; cursor: not-allowed; box-shadow: none; }
            
            @media (max-width: 480px) { 
                .nx-3d-select { min-width: 200px; font-size: 15px; } 
                .nx-3d-btn { width: 38px; height: 38px; font-size: 14px; } 
                .nx-3d-container { gap: 8px; padding: 8px 12px; }
            }
        `;
        document.head.appendChild(style);
    };
