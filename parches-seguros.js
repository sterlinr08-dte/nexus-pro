...
(function(){
  ...
  load('parches-seguros-base.js',function(){load('parches-crm-seguros.js',function(){css('parches-crm-seguros-v2.css');load('parches-crm-entrada.js',function(){load('parches-crm-operativo.js',function(){load('parches-whatsapp-inbox.js',function(){load('parches-whatsapp-visual.js',function(){css('parches-whatsapp-visual-v2.css');load('parches-whatsapp-visual-v3.js',function(){load('parches-whatsapp-visual-v4.js',function(){load('parches-whatsapp-visual-v5.js',function(){load('parches-whatsapp-visual-v6.js',function(){load('parches-whatsapp-visual-v7.js');});});});});});});});});});
})();