...
(function(){
  ...
  load('parches-seguros-base.js',function(){load('parches-crm-seguros.js',function(){css('parches-crm-seguros-v2.css');load('parches-crm-entrada.js',function(){load('parches-crm-operativo.js');});});});
})();