...
- **Estado de migración:** AGUAPRO 100% migrado (6 pestañas, 21 pruebas Playwright en
  ...
  **PENDIENTE** migrar el resto por tandas: POS (`.nxLupaBox` x5 + inputs inline en
  NC/Historial/PH/pendientes), Préstamos, Vehículos, Rifas (`.rfSearch` x2), Consultorio
  (`.nxMdSearch`). Al migrar cada uno: conservar su lógica de filtro, solo cambiar el
